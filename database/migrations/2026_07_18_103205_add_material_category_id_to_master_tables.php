...
return new class extends Migration
{
    ...
    {
        Schema::table('learning_methods', function (Blueprint $table) {
            $table->foreignId('material_category_id')->nullable()->after('id')->constrained('material_categories')->onDelete('cascade');
        });
