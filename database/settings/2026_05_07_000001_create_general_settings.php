...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('general.school_name', 'SMP Al Wathoniyah 9');
        ...
        $this->migrator->add('general.email', 'info@smpalwathoniyah9.sch.id');
        ...
        $this->migrator->add('general.meta_title', 'SMP Al Wathoniyah 9');
        $this->migrator->add('general.meta_description', 'Website resmi SMP Al Wathoniyah 9');
        $this->migrator->add('general.og_image', null);
        $this->migrator->add('general.footer_text', 'SMP Al Wathoniyah 9 - Mendidik dengan hati.');
        $this->migrator->add('general.copyright', '© ' . date('Y') . ' SMP Al Wathoniyah 9. All rights reserved.');
    }
};
