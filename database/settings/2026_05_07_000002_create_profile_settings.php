...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('profile.history', '<p>Sejarah singkat SMP Al Wahoniyah 9...</p>');
        ...
        $this->migrator->add('profile.principal_message', '<p>Selamat datang di website resmi SMP Al Wahoniyah 9.</p>');
